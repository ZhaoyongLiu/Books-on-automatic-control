...
控制科学与工程学科是一门交叉学科，包含控制理论与控制工程、模式识别与智能系统、导航制导与控制、检测技术与自动化装置和系统工程等二级学科，在本科阶段叫作自动化。控制科学与工程涉及数学、物理、机械、计算机、通信、电子电气和航空航天等领域的知识，在国防、工业和生产生活中具有十分重要的作用。作为一个自动化相关的科研、从业人员，除了赖以谋生的显示的各类技能，相关基础知识也必不可缺，正所谓“不积跬步，无以至千里”。下面列出了我在南理工学习过程中的一些由浅入深、高屋建瓴的学习书单，供大家参考。
