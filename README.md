...
| 大三上 | 高频电子线路、传感器与检测技术、嵌入式控制系统及应用、电力电子技术、控制工程基础(搭建模拟控制电路)、微机原理与接口技术(汇编语言编程) | 多媒体技术基础、PCB设计| EDA设计(模电)、电工电子综合实验(数电)、Matlab控制系统计算机辅助设计 |
...
| 大四上 | 最优控制、数字信号处理 | 模糊控制(基于Simulnk的倒立摆实物模糊控制)、航天器控制技术、数字图像处理 | EDA综合实验(基于FPGA的自动贩卖机控制系统设计)、嵌入式控制系统综合实验(基于Linux系统的交通灯控制系统设计)、控制系统案例分析(混沌、时滞、多智能体、Petri网) 、毕业实习(基于树莓派的两轮平衡车自平衡与轨迹跟踪控制)| 江苏省大学生机器人大赛(基于Arduino语言的格斗搏击机器人设计)|
