...
| 大二下 | 模电、数电、数据通信与网络、概统、自动控制元件(控制电机) | 网页设计(HTML、CSS、JavaScript) | 电工电子综合实验(电路)、电工实习、科研训练 | 江苏省大学生机器人大赛(无人车多车交互)|
| 大三上 | 高频电子线路、传感器与检测技术、嵌入式控制系统及应用、电力电子技术、控制工程基础(搭建模拟控制电路)、微机原理与接口技术(汇编语言编程) | 多媒体技术基础、PCB设计| EDA设计(模电)、电工电子综合实验(数电)、Matlab控制系统计算机辅助设计(三容水箱液位控制) |
| 大三下 | 过程控制(基于C语言的水箱液位控制)、运动控制(电机伺服控制)、PLC原理及应用(西门子S7-200)、现代控制理论(基于Simulnk的倒立摆实物LQR控制)| 控制系统综合课程设计(基于卡尔曼滤波的飞行目标状态估计)、建模与辨识基础、无人机控制技术 | 就业指导 |
| 大四上 | 最优控制、数字信号处理 | 模糊控制(基于Simulnk的倒立摆实物模糊控制)、航天器控制技术、数字图像处理 | EDA综合实验(基于FPGA的自动贩卖机控制系统设计)、嵌入式控制系统综合实验(基于Linux系统的交通灯控制系统设计)、控制系统案例分析(混沌、时滞、多智能体、Petri网) 、毕业实习(基于树莓派的两轮平衡车自平衡与轨迹跟踪控制)| 江苏省大学生机器人大赛(基于Arduino的格斗搏击机器人设计)|
