...
| 大四上 | 最优控制、数字信号处理 | 模糊控制(基于Simulnk的倒立摆实物模糊控制)、航天器控制技术、数字图像处理 | EDA综合实验(基于FPGA的自动贩卖机设计)、嵌入式控制系统综合实验(基于Linux系统的交通灯设计)、控制系统案例分析(混沌、时滞、多智能体、Petri网) 、毕业实习(基于树莓派的两轮平衡车自平衡与轨迹跟踪控制)| 江苏省大学生机器人大赛(格斗搏击)|
