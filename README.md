...
控制科学与工程学科是一门交叉学科，涉及数学、物理、机械、计算机、通信、电子电气和航空航天等领域的知识，其核心是各种基于数学和物理的控制、优化等基础理论，在国防、工业、农业、交通、生物、医学、经济等领域中具有十分重要的作用。控制科学与工程包含控制理论与控制工程、模式识别与智能系统、导航制导与控制、检测技术与自动化装置和系统工程等二级学科，在本科阶段叫作自动化。作为一个自动化相关的科研、从业人员，除了学习各类赖以生存的显式技能、锻炼核心的竞争能力之外，还应当打牢相应的学科基础，从而有一个长远的发展（Bottom-up），正所谓 “行稳健，方致远”。下面列出的是我在南理工学习过程中整理的一份书单，并提供了电子书（仅交流学习使用），供大家参考。

_注：本书单是在自动化本、硕、博培养计划（以南理工为例）基础上的一个扩充，大家可以根据任务以及需求导向的方式（Top-down）进行学习（例如根据当下的比赛、科研项目等要求，边做边学）。在学习过程中，我们既要理解我们所研究的物理对象（基于物理、数据等知识进行数学建模），搞清楚我们可采用的控制手段（包括使用什么样的传感器、控制器和执行器），又要弄清楚所采用的控制及优化算法的数学原理、适用范围和优缺点，最关键的是要具备相应的理论推导、代码实现（电路设计、机械设计、实物验证）的能力，最终的目的是更好地解决实际问题（从实践中发展理论、用实践去检验理论、用理论指导和解决实际问题）。_
| 年级 | 主干课程 | 选修课程 | 综合课程 | 学科竞赛 |
| :-----: | :----: | :----: | :----: | :----: |
| 大一上 | 工程制图、计算机导论、C语言程序设计、高等数学(I)、大学英语(I) | 引导性物理实验 | 职业生涯规划 |
| 大一下 | 线性代数、高等数学(II)、大学物理(I)、大学物理实验(I)、大学英语(II) | 空间电子技术与天文史话、工程领域中的数学问题(矩阵在密码学中的应用) | 创业教育 | 江苏省高数竞赛 |
| 大二上 | 理论力学、大学物理(II)、大学物理实验(II)、软件技术基础(数据结构)、电路、工程数学(复变函数与积分变换) | Java程序设计、控制学科前沿讲座、工程文化 | 管理学原理、金工实习 | 南理工大物竞赛 |
| 大二下 | 模电、数电、数据通信与网络、概统、自动控制元件(控制电机) | 网页设计(HTML、CSS、JavaScript) | 电工电子综合实验(三相电路设计与Multisim仿真)、电工实习、科研训练 | 江苏省大学生机器人大赛(无人车多车交互)|
| 大三上 | 高频电子线路、传感器与检测技术(电阻、电容、电感式传感器检测电路设计)、嵌入式控制系统及应用(自主移动AGV控制系统设计)、电力电子技术、控制工程基础(模拟控制电路搭建)、微机原理与接口技术(汇编语言编程) | 多媒体技术基础(无损压缩算法、数字声音编码、数字图像与电视基础、光盘存储器与多媒体通信系统)、PCB设计| EDA设计(放大电路与阶梯波发生器电路设计及其Multisim仿真)、电工电子综合实验(数字时钟设计)、Matlab控制系统计算机辅助设计(三容水箱液位控制) |
| 大三下 | 过程控制(基于C语言的单容水箱液位控制)、运动控制(电机伺服控制)、PLC原理及应用(西门子S7-200)、现代控制理论(基于Simulnk的倒立摆实物LQR控制)| 控制系统综合课程设计(基于卡尔曼滤波的飞行目标状态估计)、建模与辨识基础(伪随机信号生成、最小二乘参数辨识)、无人机控制技术(多旋翼无人机的建模、控制与状态估计) | 就业指导 |
| 大四上 | 最优控制(垂直起降VTOL飞行器的最优控制)、数字信号处理 | 模糊控制(基于Simulnk的倒立摆实物模糊控制)、航天器控制技术(航天器轨道力学与位姿控制、火箭与运载工具)、数字图像处理 | EDA综合实验(基于FPGA的自动贩卖机设计)、嵌入式控制系统综合实验(基于Linux系统的交通灯设计)、控制系统案例分析(混沌、时滞、多智能体、Petri网) 、毕业实习(基于树莓派的两轮车自平衡与轨迹跟踪控制)| 江苏省大学生机器人大赛(格斗搏击)|
| 大四下 | | | 毕业设计(室外越野机器人的软件与控制算法设计) | 全国大学生恩智浦杯智能汽车竞赛(室外电磁组)|
| 研一上 | 线性系统理论、高等工程数学(矩阵论、优化理论)、控制理论中的矩阵代数(高等代数、矩阵分析)、人工智能原理与方法、硕士英语 | 现代分析基础(泛函分析)、非线性系统与调节理论(Quanser Aero 二旋翼飞行器的输出调节)、图像分析基础 | |
...
| 博一下 | 模式识别(遥感图像变化检测)、深度学习神经网络(人体运动位姿预测) 、导航系统理论与方法| | |
...
- [五、计算机 (控制算法的实现手段)](#五计算机)
  
- [六、通信 (控制信号的传输与处理)](#六通信)
- [七、电子电气 (控制对象、算法与信号的物理实现)](#七电子电气)
- [八、航空航天 (控制算法的实际应用)](#八航空航天)
- [九、初级控制理论](#九初级控制理论)
- [十、高级控制理论](#十高级控制理论)
- [十一、复杂动态系统](#十一复杂动态系统)
- [十二、学术研究与论文写作](#十二学术研究与论文写作)
- [十三、其他应用](#十三其他应用)

## 一、逻辑学
[1] 吴军. 逻辑学通识讲义[M]. 北京：新星出版社，2025.  
[2] K. H. Rosen. Discrete Mathematics and Its Applications[M]. New York: McGraw-Hill，2012.  
[3] 青蓝图书. 一分钟漫画逻辑学[M]. 北京：航空工业出版社，2020.  
[4] 麦克伦尼. 简单的逻辑学[M]. 赵明燕，译. 北京：中国人民大学出版社，2007.  
[5] 科匹，科恩. 逻辑学导论[M]. 张建军，等，译. 北京：中国人民大学出版社，2014.  
[6] 赫尔利. 逻辑学基础[M]. 郑伟平，等，译. 北京：中国轻工业出版社，2017.  
...
[3] 菲赫金哥尔茨. 微积分学教程 第一卷[M]. 杨弢亮，叶彦谦，译. 北京：高等教育出版社，2006.  
[4] 菲赫金哥尔茨. 微积分学教程 第二卷[M]. 杨弢亮，叶彦谦，译. 北京：高等教育出版社，2006. 
...
[7] G. B. Folland. Real Analysis: Modern Techniques and Their Applications[M]. New York: Wiley, 1999.  
[8] H. Royden, P. Fitzpatrick. Real Analysis[M]. Hoboken: Pearson, 2023.  
[9] Xiaojing Ye. [Lecture Notes on Real Analysis](https://math.gsu.edu/xye/course/ra_handout/ra_notes.pdf).  
...
[3] Xiaojing Ye. [Lecture Notes on Functional Analysis](https://math.gsu.edu/xye/course/fa_handout/fa_notes.pdf).  
...
#### 1.8 最优化理论
[1] 袁亚湘，孙文瑜. 最优化理论理论与方法[M]. 北京：科学出版社，1997.  
[2] 刘浩洋，户将，李勇锋，文再文. 最优化：建模、算法与理论[M]. 北京：高等教育出版社，2020.  
...
#### 1.10 数值优化
[1] J. Nocedal, S. J. Wright. Numerical Optimization[M]. New York: Springer, 2006.  
...
#### 1.14 变分学
[1] 张恭庆. 变分学讲义[M]. 北京：高等教育出版社，2011.  
[2] 老大中. 变分学基础[M]. 北京：国防工业出版社，2015.  


#### 1.15 常微分方程
[1] 张伟年，杜正东，徐冰. 常微分方程[M]. 北京：高等教育出版社，2014.  
[2] 阿诺尔德. 常微分方程[M]. 沈家骐，等，译. 北京：科学出版社，2001.  
...
[2] D. C. Lay, et al. 线性代数及其应用[M]. 刘深泉，等，译. 北京：机械工业出版社，2018.  
[3] G. Strang. Introduction to Linear Algebra[M]. Wellesley: Wellesley-Cambridge Press, 2003.  
[4] 任广千，等. 线性代数的几何意义[M]. 西安：西安电子科技大学出版社，2015.  
...
#### 2.4 李群李代数
[1] J. Stillwell. Naive Lie Theory[M]. New York: Springer, 2008.  
...
[4] J. M. Lee. Introduction to topological manifolds[M]. New York: Springer, 2010.  


#### 3.3 微分拓扑
[1] B. I. Dundas. A short course in differential topology[M]. Cambridge University Press, 2018.  
...
[4] 孙和军，赵培标. 现代微分几何[M]. 北京：电子工业出版社，2015.  
...
### 6. 数学可视化
[1] 姜伟生. [数学要素](https://github.com/Visualize-ML/Book3_Elements-of-Mathematics)[M]. 北京：清华大学出版社，2023.  
[2] 姜伟生. [矩阵力量](https://github.com/Visualize-ML/Book4_Power-of-Matrix)[M]. 北京：清华大学出版社，2023.  
[3] 姜伟生. [统计至简](https://github.com/Visualize-ML/Book5_Essentials-of-Probability-and-Statistics)[M]. 北京：清华大学出版社，2023.  
...
#### 1.4 光学
[1] E. Hecht. 光学[M]. 秦克诚，等，译. 北京：电子工业出版社，2019.  
...
[2] 张汉壮，等. 物理学导论[M]. 北京：高等教育出版社，2016.  
...
### 9. 编程语言
[1] S. Lohr. 软件故事：谁发明了那些经典的编程语言[M]. 张沛玄，译. 北京：人民邮电出版社，2014.  

<C语言>  
[1] B. W. Kernighan, D. M. Richie. C程序设计语言[M]. 徐宝文，李至，译. 北京：机械工业出版社，2019.  
[2] 谭浩强. C程序设计[M]. 北京：清华大学出版社，2017.  
[3] 陈正冲. C语言深度解剖：解开程序员面试笔试的秘密[M]. 北京：北京航空航天大学出版社，2012.  
...
<Python语言>  
[1] 姜伟生. [编程不难](https://github.com/Visualize-ML/Book1_Python-For-Beginners)[M]. 北京：清华大学出版社，2024.  
[2] 姜伟生. [可视之美](https://github.com/Visualize-ML/Book2_Beauty-of-Data-Visualization)[M]. 北京：清华大学出版社，2024.  
...
[2] 钱玲，谷亚林，王海青. 信号与系统[M]. 北京：电子工业出版社，2017.  
...
[11] W. S. Levine. 控制手册--控制系统基础[M]. Boca Raton: CRC Press, 2011.   
[12] W. S. Levine. 控制手册--控制系统先进方法[M]. Boca Raton: CRC Press, 2011.  
...
[2] 张杰，王飞跃. 最优控制：数学理论与智能方法 上册[M]. 北京：清华大学出版社，2017.  
[3] 王天威，黄军魁. 控制之美 卷 2：最优控制 MPC 与卡尔曼滤波器[M]. 北京：清华大学出版社，2023.  
...
[3] 栾浩，樊凯，项阳. 科研有方：科研需要“想好”再“做”[M]. 西安：西安电子科技大学出版社，2014.  
[4] 肖东发，李武. 学位论文写作与学术规范[M]. 北京：北京大学出版社，2009.  
[5] [Learn LaTeX in 30 minutes](https://cn.overleaf.com/learn/latex/Learn_LaTeX_in_30_minutes).  
[6] [一份（不太）简短的 LATEX 2ε 介绍](https://texdoc.org/serve/lshort-zh-cn.pdf/0).

## 十三、其他应用
### 1. 国防军工
<兵器>  
[1] 薄煜明，等. 现代火控理论与应用基础[M]. 北京：科学出版社，2012.  

<船舶>  
[2] T. I. Fosen. Guidance and Control of Ocean Vehicles[M]. Chichester: John Wiley & Sons, 1994.  
