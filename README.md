...
控制科学与工程学科是一门交叉学科，涉及数学、物理、机械、计算机、通信、电子电气和航空航天等领域的知识，其核心是各种基于数学和物理的控制、优化等基础理论，在国防、工业、农业、交通、生物、医学、经济等领域中具有十分重要的作用。控制科学与工程包含控制理论与控制工程、模式识别与智能系统、导航制导与控制、检测技术与自动化装置和系统工程等二级学科，在本科阶段叫作自动化。作为一个自动化相关的科研、从业人员，除了学习各类赖以生存的显式技能、锻炼核心的竞争能力之外，还应当打牢相应的学科基础，从而有一个长远的发展，正所谓 “行稳健，方致远”。下面列出的是我在南理工学习过程中整理的一份深入浅出、高屋建瓴的书单，并提供了电子书，供大家参考。

_注：本书单是在自动化本、硕、博培养计划（以南理工为例）基础上的一个扩充，大家可以根据任务以及需求导向的方式进行学习（例如，如果主攻控制理论，最好学习下数分、高代、数值分析、常微分方程与动力系统等基础数学类书籍，因为理论研究的一个关键就是回答为什么的问题，而想要把问题分析地清楚透彻基本上离不开数学），最终的目的是更好地解决实际问题。大家知道，自动化专业具有培养口径宽、适应范围广的特点，因此我们可以较为容易地根据自己的兴趣爱好和就业前景选择自己的进一步研究方向，并持续发力。_
...
| 大二上 | 理论力学、大学物理(II)、大学物理实验(II)、软件技术基础(数据结构)、电路、工程数学(复变函数与积分变换) | Java程序设计、学科前沿讲座、工程文化 | 管理学原理、金工实习 | 南理工物理竞赛 |
...
| 研一上 | 线性系统理论、高等工程数学(矩阵论、方程组、优化)、控制理论中的矩阵代数(高等代数、矩阵分析)、人工智能原理与方法、硕士英语 | 现代分析基础(泛函分析)、非线性系统与调节理论 | |
| 研一下 | 机器人控制理论与技术(感知、定位、规划、控制、Ros)、智能信息处理技术(神经、进化与模糊计算、数据融合、智能优化算法) | 混杂系统、网络系统的信息处理技术(存储、检索、计算、安全)、现代测量技术与误差分析、模型降阶、有限时间观测理论 | 网络工程实验(局域网组网)、开题报告 |泰迪杯数据挖掘挑战赛(电力巡检智能缺陷检测）、华为杯研究生数学建模竞赛(辛烷值损失预测模型)|
