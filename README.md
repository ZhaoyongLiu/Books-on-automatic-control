...
_注：本书单是在自动化本、硕、博培养计划（以南理工为例）基础上的一个扩充，大家可以根据任务以及需求导向的方式进行学习（例如，如果主攻控制理论，最好学习下数分、高代、数值分析、常微分方程与动力系统等基础数学类书籍，因为理论研究的一个关键就是回答为什么的问题，而想要把问题分析地透彻基本上离不开数学），最终的目的是更好地解决实际问题。大家知道，自动化专业具有培养口径宽、适应范围广的特点，因此我们可以较为容易地根据自己的兴趣爱好和就业前景选择自己的进一步研究方向，并持续发力。_
