...
| 大三上 | 高频电子线路、传感器与检测技术(电阻、电容、电感式传感器检测电路设计)、嵌入式控制系统及应用(自主移动AGV控制系统设计)、电力电子技术、控制工程基础(模拟控制电路搭建)、微机原理与接口技术(汇编语言编程) | 多媒体技术基础(无损压缩算法、数字声音编码、数字图像与电视基础、光盘存储器与多媒体通信系统)、PCB设计| EDA设计(放大电路与阶梯波发生器电路设计及其Multisim仿真)、电工电子综合实验(数电)、Matlab控制系统计算机辅助设计(三容水箱液位控制) |
