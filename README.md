...
| 研一下 | 机器人控制理论与技术、智能信息处理技术(神经、进化与模糊计算、数据融合、智能优化算法) | 混杂系统、网络系统的信息处理技术(存储、检索、计算、安全)、现代测量技术与误差分析、模型降阶、有限时间观测理论 | 网络工程实验、开题报告 |泰迪杯数据挖掘挑战赛(电力巡检智能缺陷检测）、研究生数学建模竞赛(辛烷值损失预测模型)|
