...
注：本书单是在自动化本、硕、博培养计划（以南理工为例）上的一个扩充。众所周知，自动化专业具有培养口径宽、适应范围广的特点，因此我们可以较为容易地根据自己的兴趣爱好和就业前景选择自己的进一步研究方向，并持续发力。
...
| 研一下 | 机器人控制理论与技术、智能信息处理技术(神经、进化与模糊计算、数据融合、智能优化算法) | 混杂系统、网络系统的信息处理技术(存储、检索、计算、安全)、现代测量技术与误差分析、模型降阶、有限时间观测理论 | 网络工程实验、开题报告 |泰迪杯数据挖掘挑战赛(电力巡检智能缺陷检测）、华为杯研究生数学建模竞赛(辛烷值损失预测模型)|
| 博一上 | 机器学习、非线性系统(稳定性、微分几何、反馈线性化)、学术英语写作 | 二外法语 | |
| 博一下 | 模式识别、深度学习神经网络 | | |
