...
控制科学与工程学科是一门交叉学科，涉及数学、物理、机械、计算机、通信、电子电气和航空航天等领域的知识，其核心是各种基于数学和物理的控制、优化、识别、学习等基础理论，在国防、工业、农业、交通、生物、医学、经济等领域中具有十分重要的作用。控制科学与工程包含控制理论与控制工程、模式识别与智能系统、导航制导与控制、检测技术与自动化装置和系统工程等二级学科，在本科阶段叫作自动化。作为一个自动化相关的科研、从业人员，除了学习各类赖以生存的显式技能、锻炼核心的竞争能力之外，还应当打牢相应的学科基础，从而有一个长远的发展，正所谓 “行稳健，方致远”。下面列出了我在南理工学习过程中整理的一些深入浅出、高屋建瓴的书单，并提供了电子书，供大家参考。

ps. 本书单是在自动化专业本科和研究生课程基础上的一个扩充，下面我简单解释一下为什么作下列扩充。

首先，数学的重要性自然是不言而喻，但凡是一个科学的、严谨的学科都离不开数学。对于一个工科生来说最基础的数学三件套自然是高等数学、线性代数、概率论与数理统计。如果仅仅是为了工程应用，那么熟悉这三件套也许够用了，但一旦从事控制理论相关的研究或者想要学习先进控制理论，这三件套就不太够了。举例来说，高等数学没有涉及实数理论、不重视 epsilon-delta 语言这种底层刻画，漏掉了很多重要的定理，更重视技巧的应用而非证明等等。然而在控制理论研究中，有时候我们要根据实际需要自行刻画问题并给出定义，并在我们给出的定义基础上去推演出相关的性质、引理和定理，在这个过程中我们会用到数理逻辑的基本知识，并且经常会为了解决我们手中的问题而查阅计算和应用数学乃至基础数学方向的论文，这就要求我们具有良好的数学证明素养，否则的话做控制理论研究就会很困难。所以如果更喜欢技术方向的研究，可以偏向于控制理论的工程实现，而非控制理论的数学证明。反之，如果喜欢控制理论研究，那么自己课外学习数学课程是不可避免的了。事实上，控制理论三大顶刊 《IEEE Transactions on Automatic Control》, 《Automatica》, 《SIAM Journal on Control and Optimization》上的论文不光要求我们提出一个新颖的问题，更重要的是要求我们从底层去分析和解决这个问题，而这一切都离不开数学。有的同学可能会觉得控制理论没用，这就好像觉得数学没用一样。一种可能是某种理论的假设条件太多而不实用，至少没法用来解决你的问题；另一种可能是你甚至都看不懂这个理论，从而导致你很难将这个理论付诸实践；还有可能是你想要解决的问题还没建立起相关的理论，但你又没有相应的精力和能力去提出这样的理论，最终只能凭借工程经验来解决，但这样到头来很有可能这个问题虽然解决了，但对你来说还是一个“黑箱”。而理论研究的作用就是变“黑箱”为“白箱”，能解释清楚为什么是这样的，其内在机理、规律是什么，这也正是控制理论研究的魅力所在。所以说，控制理论和控制工程从来不是对立的，一个真正“有用”的理论一定是源于一个真的实际的问题，并且最终能反过来对这个问题的解决提供清晰的、科学的指导意见的。控制领域著名的 PID 控制、卡尔曼滤波、最优控制、模型预测控制、模糊控制等等都是既有严格数学解释又有实际工程应用价值的”好的“理论。所以说控制理论研究的意义是毋庸置疑的，时代的浪潮自然会筛选出哪些是”好的“理论，哪些是只能暂时”束之高阁“的理论。

线性代数的问题在于没有讲 Jordan 标准型这部分的内容，而且往往会漏掉线性空间和线性映射这两个重要的概念，但好在研究生阶段往往会有相应的课程来补上相关的知识，例如《控制理论中的矩阵代数》、《矩阵分析》、《高等工程数学》等等，但我还是建议大家翻阅一下数学系的《高等代数》。此外要注意的是，我们不要以数学系学生的思路来阅读数学参考书，我们的目的是补上缺失的理论知识，而不是为了做习题。所以在阅读的过程中要注意参考书的选择（有些参考书会写的很晦涩难懂，所以自己要学会挑选参考书），并且建议大家稍微花点时间阅读主要定理的证明，而且一定要结合具体的例子知道这个定理是如何应用的，有时间的话可以做一两道课后习题来检验自己的学习情况，而一些没那么重要的定理大致知道它在讲什么，就可以直接跳过，不然会花费很多时间在这上面。

再然后是概率论与数理统计这门课，如果研究生阶段研究的是机器学习、随机控制，那么这门课必须要了然于胸。
...
[2] 程其襄，张奠宙，胡善文，薛以锋. 实变函数与泛函分析基础[M]. 北京：高等教育出版社，2019.  
